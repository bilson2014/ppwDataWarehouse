...
(function($) {
    ...
    function _158(_159, _15a) {
        ...
        if (node.length == 0) {
            ...
            if (_15b(_159, node[0])) {
                ...
                // add by lutao, 2016-10-21 16:33 begin
                // -> add root class
                _15c.parent().addClass('vvv');
                // add by lutao,2016-10-21 16:33 end
        ...
        render: function(_1c1, ul, data) {
            ...
            function _1c6(_1c7, _1c8) {
                ...
                for (var i = 0; i < _1c8.length; i++) {
                    ...
                    //lt add class 2016 1021 17:02 start
                    if (item.state == "closed" || item.children && item.children.length) {
                        cc.push("<div id=\"" + item.domId + "\" class=\"tree-node firstNode tree-hit \">");
                    } else {
                        cc.push("<div id=\"" + item.domId + "\" class=\"tree-node childenNode\">");
                    }
                    //end
    ...
    $.fn.tooltip = function(_208, _209) {
        ...
        return this.each(function() {
            ...
            if (_20a) {
                ...
                $.data(this, "tooltip", {
                    options: $.extend({},
                    $.fn.tooltip.defaults, $.fn.tooltip.parseOptions(this), _208)
                });
                init(this);
            }
            _1ef(this);
    ...
    $.fn.tooltip.parseOptions = function(_20c) {
        var t = $(_20c);
        var opts = $.extend({},
        $.parser.parseOptions(_20c, ["position", "showEvent", "hideEvent", "content", {
            trackMouse: "boolean",
            deltaX: "number",
            deltaY: "number",
            showDelay: "number",
        ...
        function _224() {
            if (opts.noheader || (!opts.title && !opts.header)) {
                ...
                if (opts.header) {
                    ...
                    if (opts.minimizable) {
                        _22a(tool, "panel-tool-min",
                        function() {
                            _24e(_221);
                        });
                    }
                    if (opts.maximizable) {
                        _22a(tool, "panel-tool-max",
                        function() {
    ...
    $.fn.panel = function(_259, _25a) {
        ...
        return this.each(function() {
            ...
            if (_25b) {
                ...
                opts = $.extend({},
                $.fn.panel.defaults, $.fn.panel.parseOptions(this), _259);
                $(this).attr("title", "");
    ...
    $.fn.panel.parseOptions = function(_269) {
        ...
        return $.extend({},
        $.parser.parseOptions(_269, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "method", "header", "footer", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
        ...
        return this.each(function() {
            ...
            if (_28d) {
                ...
                _28d = $.data(this, "window", {
                    options: $.extend({},
                    $.fn.window.defaults, $.fn.window.parseOptions(this), _28a)
                });
    ...
    $.fn.window.parseOptions = function(_294) {
        return $.extend({},
        $.fn.panel.parseOptions(_294), $.parser.parseOptions(_294, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
    ...
    $.fn.dialog = function(_2a3, _2a4) {
        ...
        return this.each(function() {
            ...
            if (_2a6) {
                ...
                $.data(this, "dialog", {
                    options: $.extend({},
                    $.fn.dialog.defaults, $.fn.dialog.parseOptions(this), _2a3)
                });
            }
            _295(this);
        });
    ...
    $.fn.dialog.parseOptions = function(_2a9) {
        var t = $(_2a9);
        return $.extend({},
        $.fn.window.parseOptions(_2a9), $.parser.parseOptions(_2a9, ["toolbar", "buttons"]), {
    ...
    $.fn.accordion = function(_301, _302) {
        ...
        return this.each(function() {
            ...
            if (_303) {
                ...
                $.data(this, "accordion", {
                    options: $.extend({},
                    $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _301),
    ...
    $.fn.accordion.parseOptions = function(_30b) {
        var t = $(_30b);
        return $.extend({},
        $.parser.parseOptions(_30b, ["width", "height", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean",
            multiple: "boolean",
    ...
    function _339(_33a) {
        ...
        $(_33a).children("div.tabs-header").unbind().bind("click",
        function(e) {
    ...
    $.fn.tabs = function(_37d, _37e) {
        ...
        return this.each(function() {
            ...
            if (_37f) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({},
                    $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _37d),
                    tabs: [],
                    selectHis: []
                });
                _335(this);
    ...
    $.fn.tabs.parseOptions = function(_38c) {
        return $.extend({},
        $.parser.parseOptions(_38c, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
        },
    ...
    function _3be(_3bf, _3c0, _3c1) {
            ...
            if (!_3c3.expandMode) {
                ...
                function() {
                    if (_3c3.expandMode == "dock") {
                        ...
                        p.panel("panel").animate(_3c6.expand,
                        function() {
        ...
        p.panel("panel").animate(_3c8.collapse, _3c1,
        function() {
    ...
    function _3d0(_3d1, _3d2) {
        ...
        if (_3d3[_3d5]) {
            ...
            p.panel("panel").animate(_3d6.expand,
            function() {
                _39d(_3d1);
    ...
    $.fn.layout = function(_3e5, _3e6) {
        ...
        return this.each(function() {
            ...
            if (_3e7) {
                ...
                var opts = $.extend({},
                $.fn.layout.defaults, $.fn.layout.parseOptions(this), _3e5);
                $.data(this, "layout", {
                    options: opts,
                    panels: {
                        center: $(),
    ...
    $.fn.layout.parsePanelOptions = function(_3f5) {
        var t = $(_3f5);
        return $.extend({},
        $.fn.panel.parseOptions(_3f5), $.parser.parseOptions(_3f5, ["region", {
            split: "boolean",
    ...
    $.fn.menu = function(_42e, _42f) {
        ...
        return this.each(function() {
            ...
            if (_430) {
                ...
                _430 = $.data(this, "menu", {
                    options: $.extend({},
                    $.fn.menu.defaults, $.fn.menu.parseOptions(this), _42e)
                });
                init(this);
            }
            $(this).css({
        ...
        return this.each(function() {
            ...
            if (_44d) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({},
                    $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _44a)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.menubutton.parseOptions = function(_44f) {
        var t = $(_44f);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_44f), $.parser.parseOptions(_44f, ["menu", {
            plain: "boolean",
        ...
        return this.each(function() {
            ...
            if (_454) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({},
                    $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _451)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.splitbutton.parseOptions = function(_457) {
        var t = $(_457);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_457), $.parser.parseOptions(_457, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_480) {
                ...
                _480 = $.data(this, "switchbutton", {
                    options: $.extend({},
                    $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _47e),
    ...
    $.fn.switchbutton.parseOptions = function(_484) {
        var t = $(_484);
        return $.extend({},
        $.parser.parseOptions(_484, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
        }]), {
    ...
    function _48d(e) {
        ...
        _48f.value = opts.val(_48e); (function() {
            if (_48f.validating) {
        ...
        return this.each(function() {
            ...
            if (_4b5) {
                ...
                _4b5 = $.data(this, "validatebox", {
                    options: $.extend({},
                    $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _4b3)
                });
            }
    ...
    $.fn.validatebox.parseOptions = function(_4b6) {
        var t = $(_4b6);
        return $.extend({},
        $.parser.parseOptions(_4b6, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            interval: "number",
            deltaX: "number"
        },
        ...
        return this.each(function() {
            ...
            if (_4ee) {
                ...
                _4ee = $.data(this, "textbox", {
                    options: $.extend({},
                    $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _4ea),
                    textbox: init(this)
                });
    ...
    $.fn.textbox.parseOptions = function(_4fd) {
        var t = $(_4fd);
        return $.extend({},
        $.fn.validatebox.parseOptions(_4fd), $.parser.parseOptions(_4fd, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", {
            multiline: "boolean",
            iconWidth: "number"
        }]), {
            value: (t.val() || undefined),
    ...
    $.fn.filebox = function(_50b, _50c) {
        ...
        return this.each(function() {
            ...
            if (_50e) {
                ...
                $.data(this, "filebox", {
                    options: $.extend({},
                    $.fn.filebox.defaults, $.fn.filebox.parseOptions(this), _50b)
                });
            }
            _504(this);
        });
    ...
    $.fn.filebox.parseOptions = function(_50f) {
        var t = $(_50f);
        return $.extend({},
        $.fn.textbox.parseOptions(_50f), $.parser.parseOptions(_50f, ["accept", "separator"]), {
    ...
    function _510(_511) {
        ...
        _514();
        var _515 = _516();
        $(_511).addClass("searchbox-f").textbox($.extend({},
        opts, {
            icons: _513,
    ...
    $.fn.searchbox = function(_51b, _51c) {
        ...
        return this.each(function() {
            ...
            if (_51e) {
                ...
                $.data(this, "searchbox", {
                    options: $.extend({},
                    $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _51b)
                });
            }
            _510(this);
        });
    ...
    $.fn.searchbox.parseOptions = function(_51f) {
        var t = $(_51f);
        return $.extend({},
        $.fn.textbox.parseOptions(_51f), $.parser.parseOptions(_51f, ["menu"]), {
    ...
    function _54b(_54c, _54d) {
        ...
        if (_54e) {
            ...
            $.data(_54c, "form", {
                options: $.extend({},
                $.fn.form.defaults, $.fn.form.parseOptions(_54c), _54d)
            });
        }
    };
    function _54f(_550) {
        ...
        return this.each(function() {
            ...
            if (_568) {
                ...
                _568 = $.data(this, "numberbox", {
                    options: $.extend({},
                    $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _565)
                });
            }
            _55c(this);
        });
    ...
    $.fn.numberbox.parseOptions = function(_56a) {
        var t = $(_56a);
        return $.extend({},
        $.fn.textbox.parseOptions(_56a), $.parser.parseOptions(_56a, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
    ...
    function _575(_576) {
        ...
        $(_576).unbind(".calendar").bind("mouseover.calendar",
        function(e) {
            var t = _578(e.target);
        ...
        return this.each(function() {
            ...
            if (_59a) {
                ...
                _59a = $.data(this, "calendar", {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _598)
                });
                init(this);
            }
    ...
    function _5a1(_5a2) {
        ...
        $(_5a2).addClass("spinner-f").textbox($.extend({},
        opts, {
            icons: _5a4
        }));
        ...
        return this.each(function() {
            ...
            if (_5ab) {
                ...
                _5ab = $.data(this, "spinner", {
                    options: $.extend({},
                    $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _5a8)
                });
            }
            _5a1(this);
        });
    ...
    $.fn.spinner.parseOptions = function(_5ac) {
        return $.extend({},
        $.fn.textbox.parseOptions(_5ac), $.parser.parseOptions(_5ac, ["min", "max", {
            increment: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_5b4) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({},
                    $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _5b1)
                });
            }
            _5ad(this);
        });
    ...
    $.fn.numberspinner.parseOptions = function(_5b5) {
        return $.extend({},
        $.fn.spinner.parseOptions(_5b5), $.fn.numberbox.parseOptions(_5b5), {});
    };
        ...
        return this.each(function() {
            ...
            if (_5d2) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({},
                    $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _5cf)
                });
            }
            _5be(this);
        });
    ...
    $.fn.timespinner.parseOptions = function(_5d4) {
        return $.extend({},
        $.fn.spinner.parseOptions(_5d4), $.parser.parseOptions(_5d4, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
        ...
        return this.each(function() {
            ...
            if (_5dd) {
                ...
                $.data(this, "datetimespinner", {
                    options: $.extend({},
                    $.fn.datetimespinner.defaults, $.fn.datetimespinner.parseOptions(this), _5da)
                });
            }
            _5d8(this);
        });
    ...
    $.fn.datetimespinner.parseOptions = function(_5de) {
        return $.extend({},
        $.fn.timespinner.parseOptions(_5de), $.parser.parseOptions(_5de, []));
    };
    ...
    function _619(_61a, _61b) {
        ...
        function _61d(_61e) {
            var _61f = _61e ? 1 : 2;
            var tr = opts.finder.getTr(_61a, _61b, "body", _61f); (_61e ? dc.body1: dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
    ...
    function _63f(_640) {
        ...
        _643.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function(e) {
        ...
        _644.unbind(".datagrid").bind("click.datagrid",
        function(e) {
    ...
    function _745(_746) {
        ...
        function _74e(ids, _74f) {
            for (var i = 0; i < ids.length; i++) {
                ...
                if (_750 >= 0) { (_74f == "s" ? _659: _656)(_746, _750, true);
                }
            }
        };
    ...
    function _670(_753, _754, cb) {
        ...
        var _756 = opts.loader.call(_753, _755,
        function(data) {
    ...
    var _76e = $.extend({},
    _760(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function(_7b4) {
        var t = $(_7b4);
        return $.extend({},
        $.fn.panel.parseOptions(_7b4), $.parser.parseOptions(_7b4, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.propertygrid = function(_843, _844) {
        ...
        return this.each(function() {
            ...
            if (_846) {
                ...
                var opts = $.extend({},
                $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _843);
                opts.frozenColumns = $.extend(true, [], opts.frozenColumns);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.propertygrid.parseOptions = function(_847) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_847), $.parser.parseOptions(_847, [{
            showGroup: "boolean"
        }]));
    };
    var _848 = $.extend({},
    ...
    function _896(_8cd, _8ce, _8cf, _8d0, _8d1) {
        ...
        var _8d4 = opts.loader.call(_8cd, _8d2,
        function(data) {
    ...
    function _8ea(_8eb, _8ec) {
        ...
        if (_8ed.length) {
            ...
            _896(_8eb, row[opts.idField], _8ef, true,
            function() {
                if (cc.is(":empty")) {
                    _8ed.remove();
                } else {
        ...
        return this.each(function() {
            ...
            if (_91b) {
                ...
                _91b = $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _918),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.methods = {
        ...
        clearChecked: function(jq) {
            return jq.each(function() {
                ...
                $.map($(_926).treegrid("getCheckedNodes"),
                function(row) {
    ...
    $.fn.treegrid.parseOptions = function(_927) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_927), $.parser.parseOptions(_927, ["treeField", {
            checkbox: "boolean",
            cascadeCheck: "boolean",
            onlyLeafCheck: "boolean"
        },
    ...
    $.fn.datalist = function(_98d, _98e) {
        ...
        return this.each(function() {
            ...
            if (_990) {
                ...
                var opts = $.extend({},
                $.fn.datalist.defaults, $.fn.datalist.parseOptions(this), _98d);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.datalist.parseOptions = function(_991) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_991), $.parser.parseOptions(_991, ["valueField", "textField", "groupField", {
            checkbox: "boolean",
            lines: "boolean"
        }]));
    };
    ...
    function _997(_998) {
        ...
        $(_998).addClass("combo-f").textbox($.extend({},
        opts, {
            icons: _99e,
            onChange: function() {}
        }));
        ...
        return this.each(function() {
            ...
            if (_9d4) {
                ...
                _9d4 = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _9d1),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function(_9d7) {
        var t = $(_9d7);
        return $.extend({},
        $.fn.textbox.parseOptions(_9d7), $.parser.parseOptions(_9d7, ["separator", "panelAlign", {
            panelWidth: "number",
            hasDownArrow: "boolean",
            delay: "number",
    ...
    function _9f6(_9f7, data, _9f8) {
        ...
        $.easyui.forEach(_9f9.data, false,
        function(row) {
            if (row["selected"]) {
    ...
    function _a09(_a0a) {
        ...
        $(_a0a).combo("panel").unbind().bind("mouseover",
        function(e) {
        ...
        return this.each(function() {
            ...
            if (_a15) {
                ...
                _a15 = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _a12),
                    data: []
                });
            }
            _a09(this);
    ...
    $.fn.combobox.parseOptions = function(_a1d) {
        var t = $(_a1d);
        return $.extend({},
        $.fn.combo.parseOptions(_a1d), $.parser.parseOptions(_a1d, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
    ...
    $.fn.combotree = function(_a57, _a58) {
        ...
        return this.each(function() {
            ...
            if (_a5a) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({},
                    $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _a57)
                });
            }
            _a3c(this);
        });
    ...
    $.fn.combotree.parseOptions = function(_a60) {
        return $.extend({},
        $.fn.combo.parseOptions(_a60), $.fn.tree.parseOptions(_a60));
    };
    ...
    function _a61(_a62) {
        ...
        var grid = _a63.grid;
        $(_a62).addClass("combogrid-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
    ...
    function _a6f(_a74, _a75, _a76) {
        ...
        var _a80 = $.grep(grid.datagrid("getSelections"),
        function(row, _a81) {
        ...
        return this.each(function() {
            ...
            if (_a8f) {
                ...
                _a8f = $.data(this, "combogrid", {
                    options: $.extend({},
                    $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _a8c)
                });
            }
            _a61(this);
        });
    ...
    $.fn.combogrid.parseOptions = function(_a94) {
        var t = $(_a94);
        return $.extend({},
        $.fn.combo.parseOptions(_a94), $.fn.datagrid.parseOptions(_a94), $.parser.parseOptions(_a94, ["idField", "textField", "mode"]));
    };
    ...
    function _a95(_a96) {
        ...
        $(_a96).addClass("datebox-f").combo($.extend({},
        opts, {
            onShowPanel: function() {
                _a98(this);
                _a99(this);
        ...
        function _a98(_a9d) {
            ...
            _a9e.unbind(".datebox").bind("click.datebox",
            function(e) {
    ...
    $.fn.datebox = function(_ab2, _ab3) {
        ...
        return this.each(function() {
            ...
            if (_ab5) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({},
                    $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _ab2)
                });
            }
            _a95(this);
        });
    ...
    $.fn.datebox.parseOptions = function(_aba) {
        return $.extend({},
        $.fn.combo.parseOptions(_aba), $.parser.parseOptions(_aba, ["sharedCalendar"]));
    };
        ...
        return this.each(function() {
            ...
            if (_ad4) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({},
                    $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _ad1)
                });
            }
            _abf(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function(_ad9) {
        var t = $(_ad9);
        return $.extend({},
        $.fn.datebox.parseOptions(_ad9), $.parser.parseOptions(_ad9, ["timeSeparator", "spinnerWidth", {
            showSeconds: "boolean"
        }]));
    };
    ...
    function _af6(_af7) {
        ...
        _af9.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",
        function(e) {
    ...
    function _b01(_b02, _b03) {
        ...
        var _b07 = [];
        if (!$.isArray(_b03)) {
            _b03 = $.map(String(_b03).split(opts.separator),
            function(v) {
                return parseFloat(v);
            });
        }
        ...
        return this.each(function() {
            ...
            if (_b18) {
                ...
                _b18 = $.data(this, "slider", {
                    options: $.extend({},
                    $.fn.slider.defaults, $.fn.slider.parseOptions(this), _b16),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function(_b1c) {
        var t = $(_b1c);
        return $.extend({},
        $.parser.parseOptions(_b1c, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",

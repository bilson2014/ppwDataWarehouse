...
import com.paipianwang.SmartReport.engine.utils.AviatorExprUtils;
import com.paipianwang.SmartReport.engine.utils.ComparatorUtils;
...
public abstract class ReportDataSet {
    ...
    protected List<ColumnTreeNode> getTreeNodesByLevel(List<ReportDataColumn> columns, int level) {
        List<ReportMetaDataRow> metaDataRows = this.metaDataSet.getRows(); // 报表的统计数据集
